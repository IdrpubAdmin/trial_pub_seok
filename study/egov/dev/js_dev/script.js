...
//
// if (matchMedia("screen and (min-width: 1280px)").matches) {
//         document.querySelector('gnb-bd v1').closest('li').classList.remove("on");
//
//         $('.gnb-bd >li >a').mouseover(function () {
...
//         })
//     } else {
//         document.querySelector('gnb-bd v1').closest('li').classList.add("on");
...
//         if(this.parentElement('li').classList.contains("on")) {
//             this.parentElement('li').classList.remove("on");
//         }else{
//             this.parent('li').classList.add("on");
//         }
//     });
